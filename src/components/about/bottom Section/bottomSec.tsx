  ...
  return (
    <div>
      <p className="my-10 font-[Marcellus] max-w-[1100px]">
        Hello! My name is Ahmed. Skilled Frontend Developer specializing in
        React.js, Next.js, JavaScript and TypeScript. Adept at creating dynamic,
        responsive web applications and translating design wireframes into
        high-quality code. you can check out projects that i kept bulding{" "}
        <Link href="/projects">
